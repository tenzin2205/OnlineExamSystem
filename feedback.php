  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Aman Kumar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Aman Kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+919560209476</h4>
		<h4 style="font-family:'typo' ">amankumar@gmail.com</h4>
		<h4 style="font-family:'typo' ">Indian Institute Of Technology ,Guwahati</h4></div></div>
		</p>
      </div>
